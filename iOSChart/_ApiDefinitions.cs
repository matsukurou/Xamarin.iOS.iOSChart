...
namespace iOSChart
{
	...
	public interface ChartData
	{
		...
		void HandleEmptyAxis ([NullAllowed] IChartDataSet firstLeft, [NullAllowed] IChartDataSet firstRight);
        ...
        NSString[] GenerateXVals (nint from, nint to);
	...
	interface IBarLineScatterCandleBubbleChartData
	{
        ...
        IntPtr Constructor ([NullAllowed] NSObject[] xVals, [NullAllowed] IChartDataSet[] dataSets);
	}

	// @interface BarChartData : BarLineScatterCandleBubbleChartData
	[BaseType (typeof(IBarLineScatterCandleBubbleChartData))]
    [Model]
    ...
    [BaseType (typeof (NSObject))]
	public interface IBarLineScatterCandleBubbleChartDataProvider : IChartDataProvider
	{
    ...
    [BaseType (typeof (NSObject))]
    [Model]
	public interface BarChartDataProvider : IBarLineScatterCandleBubbleChartDataProvider
	{
	...
	[BaseType (typeof(IBarLineScatterCandleBubbleChartDataSet))]
	...
	public interface ChartDataRendererBase
	{
    ...
    [Model]
	public interface ChartViewBase : IChartDataProvider, IChartAnimatorDelegate
	{
		...
		[Wrap ("WeakDelegate")]
		[NullAllowed]
		ChartViewDelegate chartViewDelegate { get; set; }
        ...
        //unsafe void ObserveValueForKeyPath ([NullAllowed] string keyPath, [NullAllowed] NSObject @object, [NullAllowed] NSDictionary change, UnsafeMutablePointer<Void> context);
	...
	public interface BarLineChartViewBase : IBarLineScatterCandleBubbleChartDataProvider, IUIGestureRecognizerDelegate
	{
		...
		IBarLineScatterCandleBubbleChartDataSet GetDataSetByTouchPoint (CGPoint pt);
    ...
    [Model]
	public interface BarChartView : BarChartDataProvider
	{
		// -(ChartHighlight * _Nullable)getHighlightByTouchPoint:(CGPoint)pt;
		[Export ("getHighlightByTouchPoint:")]
		[return: NullAllowed]
    ...
    [BaseType (typeof (NSObject))]
	interface IBubbleChartDataProvider : IBarLineScatterCandleBubbleChartDataProvider
	{
    ...
    [BaseType (typeof (NSObject))]
	interface ICandleChartDataProvider : IBarLineScatterCandleBubbleChartDataProvider
	{
	...
	interface LineScatterCandleRadarChartRenderer
	{
		...
		unsafe void DrawHighlightLinesWithContext (CGContext context, CGPoint point, LineScatterCandleChartDataSet set);
	}
	...
	interface ChartDataBaseFilter
	{
		...
		[Export ("filter:")]
        ChartDataEntry[] Filter (NSObject[] points);
	}
    ...
    [BaseType (typeof (NSObject))]
	public interface IChartXAxisValueFormatter
	{
	...
	[BaseType (typeof(NSObject))]
	interface IChartDefaultXAxisValueFormatter : IChartXAxisValueFormatter
	{
	...
	interface ChartFillFormatter
	{
		...
		nfloat DataProvider (LineChartDataSet dataSet, ILineChartDataProvider dataProvider);
	}

	// @interface ChartHighlight : NSObject
	[BaseType (typeof(NSObject))]
	public interface ChartHighlight
	{
	...
	[BaseType (typeof(ChartRendererBase))]
	public interface ChartLegendRenderer
	{
	...
	[BaseType (typeof(ChartComponentBase))]
	public interface ChartLimitLine
	{
	...
	interface ChartSelectionDetail
	{
		...
		[DesignatedInitializer]
		IntPtr Constructor (double value, nint dataSetIndex, IChartDataSet dataSet);
	...
	[BaseType (typeof(NSObject))]
	public interface ChartTransformer
	{
		// -(instancetype _Nonnull)initWithViewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler __attribute__((objc_designated_initializer));
		[Export ("initWithViewPortHandler:")]
		[DesignatedInitializer]
	...
	[BaseType (typeof(NSObject))]
	public interface ChartViewPortHandler
	{
	...
	public interface ChartXAxisRenderer
	{
	...
	[BaseType (typeof(ChartAxisRendererBase))]
	public interface ChartYAxisRenderer
	{
    ...
    [BaseType (typeof (NSObject))]
	interface ILineChartDataProvider : IBarLineScatterCandleBubbleChartDataProvider
	{
    ...
    [BaseType (typeof (NSObject))]
	interface IScatterChartDataProvider : IBarLineScatterCandleBubbleChartDataProvider
	{
	...
	[BaseType (typeof(BarLineChartViewBase))]
	interface CombinedChartView : BarChartDataProvider, IScatterChartDataProvider, ICandleChartDataProvider, IBubbleChartDataProvider, ILineChartDataProvider
	{
		// -(void)initialize;
		[Export ("initialize")]
		void Initialize ();
	...
	interface ScatterChartDataSet
	{
		...
		unsafe CGPath CustomScatterShape { get; set; }
