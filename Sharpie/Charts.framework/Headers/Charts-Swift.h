...
@property (nonatomic, readonly) ChartData * __nullable data;
@end
...
@property (nonatomic, readonly) BarChartData * __nullable barData;
...
@property (nonatomic) UIColor * __nullable descriptionTextColor;
...
@property (nonatomic, readonly) BubbleChartData * __nullable bubbleData;
@end
...
@property (nonatomic, readonly) CandleChartData * __nullable candleData;
@end
...
@property (nonatomic) ChartTransformer * __null_unspecified transformer;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) LineChartData * __nullable lineData;
- (ChartYAxis * __nonnull)getAxis:(enum AxisDependency)axis;
@end
...
@property (nonatomic, readonly) ScatterChartData * __nullable scatterData;
@end
...
@property (nonatomic) id <ChartFillFormatter> __nullable fillFormatter;
- (id __nonnull)copyWithZone:(NSZone * __null_unspecified)zone;
@end
...
@property (nonatomic) NSAttributedString * __nullable centerAttributedText;
