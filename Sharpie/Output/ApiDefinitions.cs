...
namespace iOSChart
{
	...
	interface ChartData
	{
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] GenerateXVals (nint from, nint to);
	...
	interface ChartDataSet
	{
		...
		[Verify (StronglyTypedNSArray)]
		IntPtr Constructor ([NullAllowed] NSObject[] yVals);
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] EntriesForXIndex (nint x);
	...
	interface ChartViewBase : IChartDataProvider, IChartAnimatorDelegate
	{
		...
		[Verify (StronglyTypedNSArray)]
		void HighlightValues ([NullAllowed] NSObject[] highs);
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] GetEntriesAtIndex (nint xIndex);
	...
	interface ChartAxisBase
	{
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] AxisLineDashLengths { get; set; }
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] GridLineDashLengths { get; set; }
	...
	interface ChartLegend
	{
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] CalculatedLabelBreakPoints { get; set; }
	...
	interface PieRadarChartViewBase
	{
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] GetSelectionDetailsAtIndex (nint xIndex);
